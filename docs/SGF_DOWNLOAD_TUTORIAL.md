...
Training complete!
Weights saved to: /Users/williamcha/Desktop/gomcts/artifacts/weights.pt
```
...
# The network loads existing artifacts/weights.pt automatically
python -m gomcts.training.train_from_sgf \
    --sgf_dir ~/go_games/kgs_9x9 \
    --board_size 9 \
    --epochs 10 \
...
Then just run:
```bash
python -m gomcts.training.train_from_sgf --sgf_dir YOUR_DIRECTORY --board_size 9 --epochs 10
```
